...
def register():
    ...
    Label(register_screen, text="Enter Your Details", bg="white", width="300", height="2",
...
def login():
    ...
    Label(login_screen, text="Enter Your Details", bg="blue", width="300", height="2",
          font=("Calibri", 15, "bold")).pack()
...
def main_account_screen():
    ...
    reg = Button(text="Register", height=50, width=100, image=registerimg, compound=LEFT, command=register,
                 bg="#b1bce3")
