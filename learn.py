...
f = Frame(master, padx=25, pady=25)
ff = Frame(master)

f.configure(bg="#A9A9A9")
f1 = Frame(master, padx=25, pady=25)
f1.configure(bg="#A9A9A9")
f2 = Frame(master, padx=25, pady=25)
...
l = Button(f, text="LEARN", image=img, font=('Verdana', 30, 'bold'), command=crud1,bd=8)
e = Button(f1, text="EXECUTE", font=('Verdana', 30, 'bold'), image=img1, command=execute,bd=8)
t = Button(f2, text="TEST", font=('Verdana', 30, 'bold'), image=img2, command=test,bd=8)
